...
│   └── inkspace-nginx.conf    # Nginx reverse proxy config
└── README.md
```
...
scp -r -i your-key.pem ./InkSpace ubuntu@<EC2_PUBLIC_IP>:~/InkSpace
```
...
sudo -u postgres psql -d inkspace_db  # Connect to database
```
...
export DB_PORT=5432
export DB_USER=inkspace_user
export DB_PASSWORD=inkspace_pass_2026
export DB_NAME=inkspace_db
export PORT=5000
...
Built with 💜 by the InkSpace team. No cap, this blog platform hits different. 🛤️
